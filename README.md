...
An [Angular 22 template](angular/README.md), with an independently tested Angular 21 configuration, is also under development. It includes the same 18 components and uses the Angular Canvas adapter without Workbench. The adapter is not yet published and Canvas Create selection is pending; see its README for release blockers and local validation.
