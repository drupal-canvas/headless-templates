...
Canvas Headless lets an external frontend application (including Angular)
render Canvas components instead of Drupal. Components are
...
Native Vue, Astro and Angular components keep their framework-native rendering, not
...
projects (Next.js, TanStack Start) use Workbench as usual. In Nuxt, Astro and Angular
